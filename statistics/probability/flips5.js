questionID[currentProblem]='flips5';
question[currentProblem]='When a fair coin is flipped, the result is either an H or a T.  Such a coin is flipped three times.  The sample space of all possible outcomes is: <br><br> {HHH, HHT, HTH, HTT, THH, THT, TTH, TTT} <br><br>  What is the probability that the first and last flips are both T?<br> (Write your answer as a fraction or as a decimal rounded to three decimal places.)';
