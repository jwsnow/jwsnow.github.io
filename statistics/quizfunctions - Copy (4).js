...
var bodyTextStart="";
var bodyTextLeft="	<div id='problemArea' style='position:fixed;top:0px;bottom:0px;left:0px;right:460px;overflow-y:scroll;z-index:10;'>";
...
//	theBody.innerHTML=bodyTextLeft+'<H1>'+quizId+'</H1>'+directions+'<hr></div>'+bodyTextRight+bodyTextBottom;
	theBody.innerHTML=bodyTextLeft+'<H1>'+quizId+'</H1>'+directions+'<hr><button id="beginButton" onclick="beginAssignment();">Begin</button><hr></div>'+bodyTextRight;
	showCalculator();
	}
