...
function prepareToSubmit(){
	...
	theProblemArea.innerHTML = alertText+theProblemArea.innerHTML+ alertText + '<br><p style="height: 30px;"></p>';
...
document.getElementById('emailButton').style.background='red';
	saveQuiz();
...
var bodyTextStart="";
var bodyTextLeft="	<div id='problemArea' style='position:fixed;top:0px;bottom:30px;left:0px;right:460px;overflow:auto;-webkit-overflow-scrolling: touch;'>";
