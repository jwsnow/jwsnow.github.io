import { GOOGLE_INK_RENDERER, GoogleInkStrokeModeler, modelGoogleInkStroke } from './google-ink-modeler.js?v=5.7.19';
...
function showDialog(kind) {
  ...
  if (kind === 'install') {
    ...
    els.dialogContent.innerHTML = `<h2>Milestone ${APP_VERSION}</h2>
      <p>Milestone 5.7.19 keeps the unified document-selection model from 5.7.18 and makes Selected Documents behave like the other Files sections by removing its special always-open default. Export, Compress, and Combine still operate on the same shared selection whether documents are open or closed.</p>
